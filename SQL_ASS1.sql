...
SELECT City, COUNT(*) AS NumOfSalespeople
FROM SalesPeople
WHERE City IN ('London', 'Paris')
GROUP BY City;

SELECT S.Snum, S.Sname, COUNT(O.Onum) AS NumOfOrders, GROUP_CONCAT(O.Odate ORDER BY O.Odate) AS OrderDates
FROM SalesPeople S
